...
public class A05_how_to_show_the_location_of_driver {
	...
	public void setUp() {
		// System is a class and setProperty is a method
				System.setProperty("webdriver.chrome.driver", System.getProperty("user.dir") + "\\drivers\\chromedriver.exe"); // relative path
