...
public class B10_Use_Of_Click_Method_By_cssSelector_Locator_not_common_way_Used_Class {
	WebDriver driver;
	...
	public void loginButtonTest() throws InterruptedException {
		driver.findElement(By.cssSelector("button.cms-green-button-reg[name='Submit Login']")).click();  // used class
		Thread.sleep(5000);
	}
